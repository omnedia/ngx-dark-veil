...
@Component({
  selector: "om-dark-veil",
  standalone: true,
  imports: [CommonModule],
  templateUrl: "./ngx-dark-veil.component.html",
  styleUrl: "./ngx-dark-veil.component.scss",
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NgxDarkVeilComponent implements AfterViewInit, OnDestroy {
  ...
  private startLoop() {
    ...
    const loop = () => {
      this.program!.uniforms['uTime'].value =
        ((performance.now() - this.startTime) / 1000) * this.speed;
